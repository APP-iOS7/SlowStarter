...
/// Since CryptoBoringWrapper is a static framework, the bundle containing the resources is copied into the final product.
    static let module: Bundle = {
        let bundleName = "swift-crypto_CryptoBoringWrapper"
        ...
        fatalError("unable to find bundle named swift-crypto_CryptoBoringWrapper")
    }()
}
