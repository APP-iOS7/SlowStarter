...
/// Since SnapKit is a static framework, the bundle containing the resources is copied into the final product.
    static let module: Bundle = {
        let bundleName = "SnapKit_SnapKit"
        ...
        fatalError("unable to find bundle named SnapKit_SnapKit")
    }()
}
