...
public enum SlowStarterAsset: Sendable {
  public enum Assets {
  public static let accentColor = SlowStarterColors(name: "AccentColor")
    public static let mainColor = SlowStarterColors(name: "MainColor")
...
public final class SlowStarterColors: Sendable {
...
public extension SlowStarterColors.Color {
  @available(iOS 11.0, tvOS 11.0, watchOS 4.0, macOS 10.13, visionOS 1.0, *)
  convenience init?(asset: SlowStarterColors) {
...
public struct SlowStarterImages: Sendable {
  public let name: String
...
public extension SwiftUI.Image {
  init(asset: SlowStarterImages) {
    let bundle = Bundle.module
    self.init(asset.name, bundle: bundle)
  }

  init(asset: SlowStarterImages, label: Text) {
    let bundle = Bundle.module
    self.init(asset.name, bundle: bundle, label: label)
  }

  init(decorative asset: SlowStarterImages) {
    let bundle = Bundle.module
